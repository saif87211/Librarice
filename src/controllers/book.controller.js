...
const renderBookPage = asyncHandler(async (req, res) => {
    ...
    return res.send(200).render("book/", {
...
const renderBookEdit = asyncHandler(async (req, res) => {
    ...
    const book = books.find(b => String(b._id) === String(b));
    ...
    return res.status(200).render("/book-edit", {
...
const createOrUpdateBook = asyncHandler(async (req, res) => {
    ...
    const updatedBooks = await Book.finde().populate("bookCategory");

    return res.status(200).render("book/", {
        apiResponse: new ApiResponse(200, {
            alert: true,
            title: "Book added succefully.",
            message: "",
            bookCategories,
            books: updatedBooks
        })
